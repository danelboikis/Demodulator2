...
public class Demodulator16Bit2 {
    ...
    private static final int SKIP_SIZE = BLOCK_SIZE / (7);

    private static final String HANDSHAKE_MESSAGE = "01010101010101010101010101010101";


    public Demodulator16Bit2() {
